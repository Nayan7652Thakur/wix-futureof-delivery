    ...
    return (
        <div className="bg-subtle-gradient relative mt-20 lg:mt-14 lg:pt-52 overflow-hidden text-black">
            ...
            <div className='flex flex-col gap-4'>
                <div className='mx-2 sticky top-0 md:mx-12 bg-white shadow-2xl rounded-xl p-2 lg:p-10 flex flex-col lg:flex-row gap-10'>
                    ...
                    <div className='lg:w-1/2 flex flex-col justify-center pl-3 lg:pl-10'>
                        ...
                        <div className="mb-6">
                            <div className='flex gap-4 mb-2'>
                                <p className='text-5xl sm:text-6xl'>223 Mi</p>
                            ...
                            <div className='flex gap-4 '>
                                <p className='text-5xl sm:text-6xl'>30 Min</p>
                ...
                <div className='mx-2 md:mx-12 sticky top-0 bg-white shadow-2xl rounded-xl p-2 lg:p-10 flex flex-col-reverse lg:flex-row gap-10'>
                    ...
                    <div className='lg:w-1/2 flex justify-between items-center pl-2 lg:pl-10'>

                        {/* Content */}
                        <div className='flex flex-col justify-center'>
                            <p className='text-xl my-8'>COMPACT</p>

                            <div className="mb-6">
                                <div className='flex gap-4 mb-2'>
                                    <p className=' text-5xl sm:text-6xl'>50 kg</p>
                                    <span className="text-sm lg:text-xl mt-4">Payload Capacity
                                ...
                                <div className='flex gap-5'>
                                    <p className='text-4xl md:text-5xl '>60 Liter</p>
                                    <span className=" text-sm lg:text-xl  mt-4">Storage Compartment</span>
                                </div>
                            </div>

                            <p className='text-md leading-relaxed mb-11 lg:w-[501px]'>
                                This is a space to share more about the business: who's behind it, what it does and what this site has to offer. It’s an opportunity to tell the story behind the business or describe a special service or product it offers. You can use this section to share the company history or highlight a particular feature that sets it apart from competitors.
                            </p>
                ...
                <div className='mx-2 sticky top-0 md:mx-12 bg-white shadow-2xl rounded-xl p-2 lg:10 flex flex-col lg:flex-row gap-10'>
                    ...
                    {/* Left Info — Centered vertically */}
                    <div className='lg:w-1/2 flex flex-col justify-center p-2 lg:pl-10'>
                        <p className='text-[24px] mb-6'>ADVANCED SENSOR TECHNOLOGY</p>

                        <div className="mb-6">
                            <div className='flex gap-4  mb-2'>
                                <p className='text-5xl lg:text-6xl'>360°</p>
                        ...
                        <p className='text-md leading-relaxed mb-11 sm:w-[501px]'>
                            This is a space to share more about the business: who's behind it, what it does and what this site has to offer. It’s an opportunity to tell the story behind the business or describe a special service or product it offers. You can use this section to share the company history or highlight a particular feature that sets it apart from competitors.
                        </p>
