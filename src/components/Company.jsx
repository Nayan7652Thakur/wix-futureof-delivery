...
const Company = () => {
    return (
        <div className='bg-black text-white pt-36'>
            <div className='ml-6 lg:pl-24 flex flex-col gap-11'>
                <div className="w-full h-[2px] flex rounded-full overflow-hidden">
                    <div className="w-[40%] bg-white" />
                    <div className="w-[82%] bg-gray-500" />
                </div>
                <p className='text-xl'>COMPANY</p>
                <h1 className='text-4xl lg:text-7xl lg:w-10/12'>Volaso in Numbers</h1>
            </div>
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-5 text-white px-6 lg:px-24 mt-16'>
                {/* Card */}
                <div className=''>
