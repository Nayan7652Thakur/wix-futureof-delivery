...
const WhyVolaso = () => {
  return (
    <div className='bg-black text-white pt-14 sm:pt-20 md:pt-52'>
      <div className='ml-6 lg:pl-24 flex flex-col gap-11 mb-6'>
        <div className="w-full h-[2px] flex rounded-full overflow-hidden">
          <div className="w-[45%] bg-white" />
          <div className="w-[82%] bg-gray-500" />
        </div>
        <p className='text-lg'>WHY VOLASO</p>
        <h1 className='text-4xl  lg:text-7xl w-80 lg:w-10/12'>A Different Approach, Using a New Method of Manufacturing</h1>
        <div className='flex flex-col lg:items-end mb-5'>
          <div>

            <p className='lg:w-[446px] pr-4'>
